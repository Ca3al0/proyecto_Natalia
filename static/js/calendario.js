...
function openModal(title, body){ modalTitle.textContent=title; modalBody.innerHTML=body; modal.style.display="block"; }
...
document.addEventListener('DOMContentLoaded', function(){
    ...
    const calendar = new FullCalendar.Calendar(calendarEl, {
        ...
        events:{ url:'/transportista/api/calendario', failure:function(){ openModal('Error','No se pudieron cargar los eventos del calendario'); } },
...
document.getElementById('registroFotograficoForm').addEventListener('submit', function(e){
    ...
    const descAntes = form.querySelector('textarea[name="desc_antes"]').value;
    const descDespues = form.querySelector('textarea[name="desc_despues"]').value;
